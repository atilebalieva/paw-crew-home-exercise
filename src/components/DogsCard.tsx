...
i have this card. It is very simple and looks like a bootstrap component. Make it modern and beautiful card.
<section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
{[{ age : 7 breed : "Appenzeller" id : "TsD-OZUBBPFf4ZNZzCp9" img : "https://frontend-take-home.fetch.com/dog-images/n02107908-Appenzeller/n02107908_1030.jpg" name : "Lyric" zip_code : "95045"}].map((dog) => (
  <Card
    key={uuidv4()}
    className="cursor-pointer overflow-hidden transition-all hover:shadow-xl rounded-3xl border-4 border-accent/30 hover:border-accent/50 hover:-translate-y-1 duration-300 md:w-72 xl:w-96 pt-0"
  >
